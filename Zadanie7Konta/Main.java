...
/*
Utwórz klasę `Konto`, która zawiera pola `stan`, `numer`, `wlasciciel` (klasa `Osoba`) oraz metody umożliwiające wpłatę, wypłatę, przelewanie środków, sprawdzenie status konta.
