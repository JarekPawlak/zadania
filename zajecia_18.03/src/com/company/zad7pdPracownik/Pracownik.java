package com.company.zad7pdPracownik;
...
public class Pracownik {
    ...
    public void przedstawPracownika() {
        System.out.printf("nasz pracownik ma na imię %s, ma %s lat, oraz zamieszkuje aktualnie pod adresem: %s", imie, wiek, zwrocAktualnyAdres());
    }
